...
public class Video {
	...
	private ArrayList<VideoRating> ratingsList ;
	...
	public void calculateAverageRating() {
		...
		if (ratingsList != null) {
			System.out.println("RatingsList wasn't null!! :) " );
			for(VideoRating Rating : ratingsList){
				sumOfRatings = sumOfRatings + Rating.getRating() ; 
			}

			averageRating = sumOfRatings / (ratingsList.size()) ; 
		} else {
			System.out.println("RatingsList was null :(" );
	...
	public ArrayList<VideoRating> getRatingsList () {	
		return ratingsList ; 
	}

	public void InitializeRatingsList () {	
		ratingsList = new ArrayList<VideoRating>() ; 
	}
}
