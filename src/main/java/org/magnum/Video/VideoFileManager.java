...
public class VideoFileManager {
	...
	public void copyVideoData(Video v, OutputStream out) throws IOException {
		System.out.println("getVideoPath(v):  " +  getVideoPath(v)  );
		...
		System.out.println("copyVideoData(v,out) seems to have run succesfully  "  );
	}
	...
	public void addRatingToVideo(Video v, int rating) throws IOException{
		
		if ( v.getRatingsList() == null ) { v.InitializeRatingsList(); }		
		
		v.getRatingsList().add(new VideoRating(rating));
		System.out.println("Average rating: " + v.getAverageRating()  ); 
