...
public class AutoGradingTest {
	...
	public void testAddVideoData() throws Exception {
			System.out.println("---Entered testAddVideoData() --- ") ; 
		
		Video received = videoSvc.addVideo(video);
		
			System.out.println("---received some Video object back from the server --- ") ; 
		
			System.out.println("Video ID: " + received.getId()  );
			System.out.println("Data URL: " + received.getDataUrl()  );		
			System.out.println("ContentType: " +  received.getContentType()  );
			System.out.println("Duration: " + received.getDuration()   );
			System.out.println("Subject : " + received.getSubject()   );
			System.out.println("Title: " +  received.getTitle()  );
			
			System.out.println("BANANA BANANA BANANA BANANA BANANA BANANA BANANA BANANA BANANA BANANA "  );
			System.out.println("The TypedFile is: " + new TypedFile(received.getContentType(), testVideoData)  );
		...
		assertEquals(VideoState.READY, status.getState());
			...
			System.out.println("VideoState.READY: " + VideoState.READY );
		
			
			System.out.println("----- About to call getData(received.getId()**************" );			
			System.out.println("received.getId() = " + received.getId() );
		...
		System.out.println("originalFile file content: " + originalFile );
		System.out.println("retrieved file content: " + retrievedFile );
